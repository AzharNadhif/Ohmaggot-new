      ...
      <div class="singkat">
        <div class="card mb-3" >
          <div class="row no-gutters">
            ...
            <div class="col-md-4">
              <img src="{{asset('images/background/card-maggot.jpeg')}}" class="card-img" style="height: auto;">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="section3">
      ...
      <div class="beli">
        <div class="child">
          ...
          <div class="text-center">
            <a class="btn btn-lg" href="index_product.html" role="button"> <b> Beli Sekarang </b></a>
          </div>
